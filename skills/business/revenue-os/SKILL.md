...
name: revenue-os
description: >
  Monetization OS for developers and indie hackers. Use when asked about
  revenue strategy, pricing, ICP discovery, value propositions, outreach,
  landing pages, or going from zero to revenue. Covers the full pipeline:
  finding customers, positioning, pricing, outreach, and closing.
---

# Revenue OS — Monetization Operating System
